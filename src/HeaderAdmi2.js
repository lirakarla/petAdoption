...
const HeaderAdmi2=({title,accion, navigation, filtrado,route}) =>{
  ...
  return (
    ...
    hidden={false} />
     ...
     <View style={{flexDirection:'row',justifyContent:'space-around', alignItems:"center"}} >
      ...
      <View style={{marginTop:20,marginLeft:40,justifyContent:"center",alignItems:"center", flexDirection:"row"}}>
